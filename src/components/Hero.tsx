  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-hero overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <img src={logo} alt="Alex Iphones Supplier" className="w-28 h-28 md:w-36 md:h-36 mx-auto mb-6 object-contain drop-shadow-2xl" />
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-4 leading-[1.1]">
          <span className="text-gradient-gold">Alexiphones - Quality iPhones in South Africa</span>
        </h1>
        
        <p className="text-base md:text-lg text-muted-foreground max-w-lg mx-auto mb-6 leading-relaxed">
          Welcome to Alexiphones, your trusted source for brand new and pre-owned iPhones in South Africa. We offer quality Apple devices at competitive prices with reliable service.
        </p>
