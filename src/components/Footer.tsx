      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div>
            ...
            <Button 
              onClick={() => window.open("https://wa.me/27604980496", "_blank")}
          ...
          <div>
            ...
            <div className="space-y-3 text-muted-foreground text-sm">
              <a href="https://tiktok.com/@skiphones.rsa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-primary transition-colors">
              ...
              <a href="https://www.facebook.com/profile.php?id=100086557483377" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-primary transition-colors">
